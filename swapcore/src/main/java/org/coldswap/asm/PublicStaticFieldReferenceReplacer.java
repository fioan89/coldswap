...
public class PublicStaticFieldReferenceReplacer extends FieldBox implements ReferenceReplacer {
     ...
     */
    public PublicStaticFieldReferenceReplacer(String oldClass, FieldNode fieldToReplace, String newClass) {
