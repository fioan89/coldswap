 ...
 * public <any return type> <any method name>(long <any arg name>)
 */
public class LongMethodTransformer implements ClassFileTransformer {
    private final int maxNumberOfMethods;
    private static final Logger logger = Logger.getLogger(LongMethodTransformer.class.getName());

    static {
        logger.setLevel(ClassUtil.logLevel);
    }

    public LongMethodTransformer(int maxNumberOfMethods) {
